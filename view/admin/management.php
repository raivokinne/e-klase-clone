							...
							<tbody class="bg-white divide-y divide-gray-200">
								<?php if (isset($students) && !empty($students)): ?>
									<?php foreach ($students as $student): ?>
										<tr>
											<td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700"><?= $student->id_number; ?></td>
											<td class="px-6 py-4 whitespace-nowrap">
												<div class="text-sm font-medium text-black"><?= $student->first_name . ' ' . $student->last_name; ?></div>
											</td>
											...
											<td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
												<a href="/edit/<?= $student->id; ?>/student" class="text-gray-800 hover:text-black mr-3">Edit</a>
												<a href="/delete/<?= $student->id; ?>/student" class="text-gray-800 hover:text-black" onclick="return confirm('Are you sure you want to delete this student?')">Delete</a>
											</td>
										</tr>
									<?php endforeach; ?>
								<?php else: ?>
								...
								<?php if (isset($teachers) && !empty($teachers)): ?>
									<?php foreach ($teachers as $teacher): ?>
										<tr>
											...
											<td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
												<a href="/edit/<?php echo $teacher->id; ?>/teacher" class="text-gray-800 hover:text-black mr-3">Edit</a>
												<a href="/delete/<?php echo $teacher->id; ?>/teacher" class="text-gray-800 hover:text-black" onclick="return confirm('Are you sure you want to delete this teacher?')">Delete</a>
											</td>
										</tr>
									<?php endforeach; ?>
								<?php else: ?>
